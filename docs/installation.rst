...
To install nursepy, run this command in your terminal:

.. code-block:: console

    $ pip install -i https://test.pypi.org/simple/ nursepy

This is the preferred method to install nursepy, as it will always install the most recent stable release.
...
The sources for nursepy can be downloaded from the `Github repo`_.
